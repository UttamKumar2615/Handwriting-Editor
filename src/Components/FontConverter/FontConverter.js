...
function FontConverter() {
  ...
  const [fontFamily, setFontFamily] = useState("'Architects Daughter', normal");
        ...
        <div className="font_selector">
          ...
          <div className="gridOne">
            ...
            <div className="fontWeight" style={{ marginBottom: "1.5rem" }}>
              <InputLabel id="fontWeight" style={{ marginBottom: "0.5rem" }}>
                Choose your own Font
              </InputLabel>
              <Button
                className="fontUpload"
                variant="contained"
                component="label"
              >
                <input
                  ...
                  onChange={handleAddFontFromFile}
                />
              </Button>
            </div>
